...
Cada skill vive dentro de una carpeta con su nombre:
...
- Los skills de **proyecto** van dentro del repositorio o carpeta del proyecto. Son ideales para convenciones de equipo.
- Los skills **globales** van en tu carpeta personal de configuración. Sirven para reglas que aplicas siempre, como tu guía de estilo personal.

::: {.callout-tip}
Si trabajas con un equipo, usa skills de proyecto y versiona la carpeta `.opencode/` con Git. Así todo el mundo comparte las mismas reglas.
:::
