...
## Tres formas de acceder a un modelo

No confundir *modelo de IA* (el cerebro que responde) con
*modelo de acceso* (la ruta por la que llega tu pregunta).

| Acceso | Analogía | Ejemplos |
|--------|----------|----------|
| **Cloud** | Biblioteca pública: vas, consultas, vuelves | Zen (gratuito), DeepSeek, GPT-4o-mini |
| **Local** | Estantería propia: la tienes en casa | Ollama, LM Studio (Qwen, Llama) |
| **Desactivado** | Biblioteca cerrada por reformas | Proveedor que apagaste |

::: {.callout-tip}
## ¿Cuál te conviene?
- **Empiezas** → Cloud (sin configuración, gratis)
- **Privacidad** → Local (todo se queda en tu red)
- **No usas** → Desactivado (evita confusiones)
:::
...
Ampliando Modelos de IA ([HTML](ampliando/ampliando-modelos.html){target="_blank"} | [PDF](ampliando/ampliando-modelos.pdf){target="_blank"}) — tabla
...
Ampliando Conexiones y proveedores ([HTML](ampliando/ampliando-conexiones.html){target="_blank"} | [PDF](ampliando/ampliando-conexiones.pdf){target="_blank"})
...
- Ampliando modelos de IA ([HTML](ampliando/ampliando-modelos.html){target="_blank"} | [PDF](ampliando/ampliando-modelos.pdf){target="_blank"})
- Ampliando conexiones y proveedores ([HTML](ampliando/ampliando-conexiones.html){target="_blank"} | [PDF](ampliando/ampliando-conexiones.pdf){target="_blank"})
- Ampliando elegir modelo IA ([HTML](ampliando/guia-elegir-modelo-ia-opencode.html){target="_blank"} | [PDF](ampliando/guia-elegir-modelo-ia-opencode.pdf){target="_blank"}) — comparativa y guía por tarea
